...
from car.views import home_view, create_ad_view, special_offers_view, edit_ad, car_ad_detail, CarAdDeleteView
...
urlpatterns = [
    ...
    path('delete/<int:pk>/', CarAdDeleteView.as_view(), name='delete_ad'),
